...
AS $$
DECLARE
  project_url TEXT := 'https://ububzrobjahuippkleeb.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVidWJ6cm9iamFodWlwcGtsZWViIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMjU5MTA0MywiZXhwIjoyMDI4MTY3MDQzfQ.2E1UDLNS4WLTyyM74A9AxG2AesgRH1MurFnotzDas3M'; -- full access needed for http request to storage
